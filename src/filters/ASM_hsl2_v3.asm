...
;                                                                           ;
;   	Implementacion de la funcion HSL 2-variacion 3  					;
;       hslTOrgb.calcX -> en lugar de naiv mod, mod con truncamiento	    ;
;                                                                           ;
; ************************************************************************* ;
extern malloc
extern free  
...
hslTOrgb3: ; rdi = float *src rsi = uint8_t *dst
	...
	movdqu xmm13, xmm5   ;xmm13 = 1
	movdqu xmm12, [cmod2];xmm12 = 2.0
	movdqu xmm14, xmm11  ;xmm14 = h/60
	divss  xmm14, xmm12  ;xmm14 = h/60/2
	cvttss2si r8, xmm14  ;r8    = ent(h/60/2)
	cvtsi2ss xmm14, r8   ;xmm14 = ent(h/60/2)
	mulss  xmm14, xmm12  ;xmm14 = ent(h/60/2)*2
	subss  xmm11, xmm14  ;xmm11 = mod(h/60, 2)
